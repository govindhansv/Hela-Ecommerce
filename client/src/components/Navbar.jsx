...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="bg-white px-2 sm:px-4 py-2.5 h-[120px] w-full dark:bg-gray-800">
            ...
            <div className="flex justify-center items-center p-2 md:hidden">
              ...
              <div className="">
                <button
                  ...
                  aria-expanded="false"
                  className="inline-flex items-center p-2 text-sm text-[#c74252] rounded-lg  focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      {showSideNavbar && (
        <div id="mobile-menu-2" className="mobile-menu-class bg-white">
          ...
          <ul>
            ...
            <li>
              <NavLink
                className="block py-2 pr-4 pl-3 text-xl text-[#c74252] font-semibold rounded md:bg-transparent md:p-0 "
            ...
            <li>
              <NavLink
                className="block py-2 pr-4 pl-3 text-xl text-[#c74252] font-semibold  rounded md:bg-transparent md:p-0 dark:text-white"
                to="/collections"
              >
                All Products
              </NavLink>
